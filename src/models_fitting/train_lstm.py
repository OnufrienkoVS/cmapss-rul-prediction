...
def train_and_save(dataset: str, data_dir: str = '../../data/processed', model_dir: str = '../../models') -> None:
    ...
    # Сохранение модели
    model_path = (script_dir / model_dir / f'lstm_{dataset}.pt').resolve()
...
def train_for_all_datasets(
    ...
    """Обучает LSTM модели для всех датасетов C-MAPSS."""
    logger.info("Запуск обучения LSTM на всех датасетах...")
